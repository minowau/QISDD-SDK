...
var ZKPProver = /** @class */ (function () {
        ...
        return __awaiter(this, arguments, void 0, function (inputs, circuitId) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_4 = _a.sent();
                        logger.error('ZKP proof generation failed', error_4, { circuitId: circuitId, operationId: operationId });
                        throw error_4;
    ...
    ZKPProver.prototype.generateMockProof = function () {
        ...
        var proofData = {
            pi_a: [(0, crypto_1.randomBytes)(32).toString('hex'), (0, crypto_1.randomBytes)(32).toString('hex'), "1"],
            pi_b: [[(0, crypto_1.randomBytes)(32).toString('hex'), (0, crypto_1.randomBytes)(32).toString('hex')],
                [(0, crypto_1.randomBytes)(32).toString('hex'), (0, crypto_1.randomBytes)(32).toString('hex')],
                ["1", "0"]],
            pi_c: [(0, crypto_1.randomBytes)(32).toString('hex'), (0, crypto_1.randomBytes)(32).toString('hex'), "1"],
            protocol: "groth16",
            curve: "bn128"
        };
    ...
    ZKPProver.prototype.generateVerificationKey = function (circuitId) {
        return (0, crypto_1.createHash)('sha256').update("vk_".concat(circuitId, "_").concat(Date.now())).digest('hex');
    };
    return ZKPProver;
}());
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        isValid = proofData.protocol === 'groth16' && proofData.pi_a && proofData.pi_b && proofData.pi_c;
                        logger.endPerformanceTimer(operationId, {
                    ...
                    case 3:
                        error_5 = _a.sent();
                        logger.error('ZKP proof verification failed', error_5, { operationId: operationId });
...
var Shamir = /** @class */ (function () {
    ...
    Shamir.prototype.reconstructSecret = function (shares) {
        ...
        for (var i = 0; i < requiredShares.length; i++) {
            ...
            var term = (yi * numerator * this.modInverse(denominator, this.prime)) % this.prime;
...
var KeyManager = /** @class */ (function () {
    ...
    KeyManager.prototype.listKeys = function () {
        return Array.from(this.keys.values()).map(function (key) { return (__assign(__assign({}, key), { privateKey: Buffer.alloc(0) // Don't expose private keys in listings
         })); });
    };
    return KeyManager;
}());
